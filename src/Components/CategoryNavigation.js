            ...
            <ul className='border border-gray-300 border-t-0'>
                <li>
                    <div className='flex w-28 md:w-full items-center px-4 border-b  border-gray-300'>
                        ...
                        <h3 className='text-sm hidden md:block'>Atta , Dal and Rice</h3>
                    </div>
                </li>
                ...
                <li>
                    <div className='flex w-28 md:w-full items-center px-4 border-b border-gray-300'>
                        ...
                        <h3 className='text-sm hidden md:block'>Baby Care</h3>
                    </div>
                </li>
                ...
                <li>
                    <div className='flex w-28 md:w-full items-center px-4 border-b border-gray-300'>
                        ...
                        <h3 className='text-sm hidden md:block'>Bakery & Biscuits</h3>
                    </div>
                </li>
                ...
                <li>
                    <div className='flex w-28 md:w-full items-center px-4 border-b border-gray-300'>
                        ...
                        <h3 className='text-sm hidden md:block'>Chicken and Meat</h3>
                    </div>
                </li>
                ...
                <li>
                    <div className='flex w-28 md:w-full items-center px-4 border-b border-gray-300'>
                        ...
                        <h3 className='text-sm hidden md:block'>Cleaning Essentials</h3>
                    </div>
                </li>
                ...
                <li>
                    <div className='flex w-28 md:w-full items-center px-4 border-b border-gray-300'>
                        ...
                        <h3 className='text-sm hidden md:block'>Cold Drinks and Juices</h3>
                    </div>
                </li>
            </ul>
        </nav>
